...
# These roles use IRSA (IAM Roles for Service Accounts) with OIDC

# AWS Load Balancer Controller IAM Role
# Required for managing ALB/NLB resources in EKS
...
# Required for EBS volume provisioning and management
...
# Required for EFS volume provisioning and management
resource "aws_iam_policy" "efs_csi_driver" {
  name        = "${var.project_name}-efs-csi-driver-policy"
...
# Required for automatic DNS record management in Route53
